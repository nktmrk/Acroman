...
import { Nags, Events, Categories } from "../collections";
...
class AdminEvents extends Component {
  ...
  render() {
    return (
      <div>
        <a href="#" onClick={() => window.history.back()} className="ui labeled icon button">
...
class AdminCategories extends Component {
  ...
  constructor(props){
    ...
    this.updateAddCategoryValue = this.updateAddCategoryValue.bind(this);
  ...
  addCategory(evt) {
    ...
    const $btn = $(evt.currentTarget);
    $btn.addClass("loading");
    const category = this.state.addCategoryValue;
        ...
        <div className="ui bottom attached tab segment" data-tab="second">
          <div className="ui fluid action input">
            <input
              ...
              onChange={this.updateAddCategoryValue}
